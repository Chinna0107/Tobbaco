    ...
    <div style={{ marginTop: '100px' }}>
      ...
      <section className="hero-section" style={{
        ...
        <div style={{
          ...
          right: 0,
          bottom: 0,
          background: 'linear-gradient(135deg, rgba(0, 0, 0, 0.7), rgba(102, 126, 234, 0.5))'
        }}></div>
      ...
      <section id="about" style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 'clamp(1rem, 2.5vw, 1.2rem)', color: 'rgba(255, 255, 255, 0.8)', marginBottom: 'clamp(2rem, 5vw, 3rem)', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: 'clamp(1.5rem, 4vw, 2rem)', fontWeight: 'bold', marginBottom: 'clamp(1rem, 3vw, 1.5rem)', color: '#d4af37' }}>Our Story</h3>
              <div style={{ fontSize: 'clamp(0.95rem, 2.5vw, 1.05rem)', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.9)' }}>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: 'clamp(1.5rem, 4vw, 2rem)', fontWeight: 'bold', marginBottom: 'clamp(1rem, 3vw, 1.5rem)', color: '#d4af37' }}>Why Choose VTC?</h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                  <FaStar style={{ fontSize: '2rem', color: '#d4af37', flexShrink: 0, marginTop: '0.2rem' }} />
                  <div>
                    <h4 style={{ fontSize: 'clamp(1.1rem, 3vw, 1.3rem)', fontWeight: 'bold', color: '#fff', marginBottom: '0.5rem' }}>Premium Quality</h4>
                    <p style={{ fontSize: 'clamp(0.9rem, 2.5vw, 1rem)', color: 'rgba(255, 255, 255, 0.8)', lineHeight: '1.6' }}>High-grade tobacco meeting international standards</p>
                  </div>
                </div>
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                  <FaGlobe style={{ fontSize: '2rem', color: '#d4af37', flexShrink: 0, marginTop: '0.2rem' }} />
                  <div>
                    <h4 style={{ fontSize: 'clamp(1.1rem, 3vw, 1.3rem)', fontWeight: 'bold', color: '#fff', marginBottom: '0.5rem' }}>Global Reach</h4>
                    <p style={{ fontSize: 'clamp(0.9rem, 2.5vw, 1rem)', color: 'rgba(255, 255, 255, 0.8)', lineHeight: '1.6' }}>Export to 50+ countries with seamless logistics</p>
                  </div>
                </div>
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                  <FaUsers style={{ fontSize: '2rem', color: '#d4af37', flexShrink: 0, marginTop: '0.2rem' }} />
                  <div>
                    <h4 style={{ fontSize: 'clamp(1.1rem, 3vw, 1.3rem)', fontWeight: 'bold', color: '#fff', marginBottom: '0.5rem' }}>Customer-Centric</h4>
                    <p style={{ fontSize: 'clamp(0.9rem, 2.5vw, 1rem)', color: 'rgba(255, 255, 255, 0.8)', lineHeight: '1.6' }}>Tailored solutions for specific requirements</p>
                  </div>
                </div>
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                  <FaAward style={{ fontSize: '2rem', color: '#d4af37', flexShrink: 0, marginTop: '0.2rem' }} />
                  <div>
                    <h4 style={{ fontSize: 'clamp(1.1rem, 3vw, 1.3rem)', fontWeight: 'bold', color: '#fff', marginBottom: '0.5rem' }}>Experienced Leadership</h4>
                    <p style={{ fontSize: 'clamp(0.9rem, 2.5vw, 1rem)', color: 'rgba(255, 255, 255, 0.8)', lineHeight: '1.6' }}>Decades of expertise under Sankaraiah Nadendla</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="products" style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{ textAlign: 'center', color: 'rgba(255, 255, 255, 0.8)', marginBottom: 'clamp(2rem, 5vw, 3rem)', fontSize: 'clamp(1rem, 2.5vw, 1.1rem)' }}>
      ...
      <section id="team" style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{ textAlign: 'center', color: 'rgba(255, 255, 255, 0.8)', marginBottom: 'clamp(2rem, 5vw, 3rem)', fontSize: 'clamp(1rem, 2.5vw, 1.2rem)' }}>
          ...
          <div style={{
            ...
            {[
              ...
              { name: 'Sarah Johnson', role: 'Export Manager', image: 'https://randomuser.me/api/portraits/women/44.jpg' },
              { name: 'Michael Chen', role: 'Quality Control', image: 'https://randomuser.me/api/portraits/men/46.jpg' },
              { name: 'Emily Davis', role: 'Operations Head', image: 'https://randomuser.me/api/portraits/women/68.jpg' }
            ].map((member, i) => (
              <div key={i} style={{
                background: 'rgba(255, 255, 255, 0.05)',
                backdropFilter: 'blur(20px)',
              ...
              onMouseLeave={(e) => {
                ...
                <h3 style={{ fontSize: 'clamp(1.1rem, 2.5vw, 1.3rem)', fontWeight: 'bold', marginBottom: '0.5rem', color: '#d4af37' }}>{member.name}</h3>
                <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontWeight: '600', fontSize: 'clamp(0.9rem, 2vw, 1rem)' }}>{member.role}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div style={{
            ...
            {[
              ...
              onMouseLeave={(e) => {
                ...
                <p style={{ color: 'rgba(255, 255, 255, 0.9)', lineHeight: '1.6', marginBottom: '1.5rem', fontSize: 'clamp(0.9rem, 2vw, 1rem)', fontStyle: 'italic' }}>
                  "{testimonial.text}"
                </p>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ textAlign: 'center', padding: 'clamp(1rem, 2vw, 1.5rem)' }}>
                ...
                <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: 'clamp(0.9rem, 2vw, 1rem)' }}>info@pammitobacco.com</p>
              </div>
              <div style={{ textAlign: 'center', padding: 'clamp(1rem, 2vw, 1.5rem)' }}>
                <div style={{ fontSize: 'clamp(2rem, 5vw, 2.5rem)', marginBottom: '0.5rem' }}>📞</div>
                <h3 style={{ fontSize: 'clamp(1rem, 2.5vw, 1.2rem)', fontWeight: 'bold', marginBottom: '0.5rem', color: '#d4af37' }}>Phone</h3>
                <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: 'clamp(0.9rem, 2vw, 1rem)' }}>+1 (555) 123-4567</p>
              </div>
              <div style={{ textAlign: 'center', padding: 'clamp(1rem, 2vw, 1.5rem)' }}>
                <div style={{ fontSize: 'clamp(2rem, 5vw, 2.5rem)', marginBottom: '0.5rem' }}>📍</div>
                <h3 style={{ fontSize: 'clamp(1rem, 2.5vw, 1.2rem)', fontWeight: 'bold', marginBottom: '0.5rem', color: '#d4af37' }}>Location</h3>
                <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: 'clamp(0.9rem, 2vw, 1rem)' }}>Andhra Pradesh, India</p>
              </div>
            </div>
